...
def Model_Block(hindcast_input_size, forecast_input_size, hindcast_output_size, forecast_output_size, hidden_size, num_layers, device):
...
def Prepare_Basin(basins, climatological_flows, static_indices, final_forcing_distance, basin_usage_counter):
...
# Need to change this, don't need to flatten and can make offset go back to start of water year
...
# This shouldn't really change? Just goes into forecast LSTM as is
...
# This shouldn't need to change much, just take unflattened list of history first and then the forcings
    ...
    try:
        for epoch in range(n_epochs):
            ...
            for i in range(0, Size, batch_size):
                ...
                basin, climatological_basin_flow, static_basin_indices, basin_usage_counter = Prepare_Basin(basins, climatological_flows, static_indices, final_forcing_distance, basin_usage_counter)
